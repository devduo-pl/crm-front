...
export const Icons = {
  ...
  Companies: ({ className = "w-5 h-5" }: IconProps = {}) => (
    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" className={className}>
  ...
  Projects: ({ className = "w-5 h-5" }: IconProps = {}) => (
    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
    </svg>
  ),

  Team: ({ className = "w-5 h-5" }: IconProps = {}) => (
    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" className={className}>
  ...
  Documents: ({ className = "w-5 h-5" }: IconProps = {}) => (
    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" className={className}>
  ...
  AlertCircle: ({ className = "w-6 h-6" }: IconProps = {}) => (
    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" className={className}>
  ...
  // Loading Icon
  Spinner: ({ className = "w-4 h-4" }: IconProps = {}) => (
